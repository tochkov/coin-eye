...
//        Log.cyan("......................");
//
//        BigDecimal advantage1a = getAdvantagePercent("USD-->BTC-->ETH ++ MAKER", new BigDecimal("100"), USD_BTC_ask, BTC_ETH_bid, ETH_USD_bid);
//        BigDecimal advantage2a = getAdvantagePercent("USD-->ETH-->BTC ++ MAKER", new BigDecimal("100"), USD_ETH_ask, ETH_BTC_bid, BTC_USD_bid);
//
//        BigDecimal advantage3a = getAdvantagePercent("BTC-->USD-->ETH ++ MAKER", new BigDecimal("1"), BTC_USD_ask, USD_ETH_bid, ETH_BTC_bid);
//        BigDecimal advantage4a = getAdvantagePercent("BTC-->ETH-->USD ++ MAKER", new BigDecimal("1"), BTC_ETH_ask, ETH_USD_bid, USD_BTC_bid);
//
//        BigDecimal advantage5a = getAdvantagePercent("ETH-->BTC-->USD ++ MAKER", new BigDecimal("10"), ETH_BTC_ask, BTC_USD_bid, USD_ETH_bid);
//        BigDecimal advantage6a = getAdvantagePercent("ETH-->USD-->BTC ++ MAKER", new BigDecimal("10"), ETH_USD_ask, USD_BTC_bid, BTC_ETH_bid);
        ...
        Log.cyan("***HIGH SCORE 1: " + highScore1);
        Log.cyan("***HIGH SCORE 2: " + highScore2);
        Log.cyan("***HIGH SCORE 3: " + highScore3);
        Log.cyan("***HIGH SCORE 4: " + highScore4);
        Log.cyan("***HIGH SCORE 5: " + highScore5);
        Log.cyan("***HIGH SCORE 6: " + highScore6);
